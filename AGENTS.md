...
Version 0.1.0 establishes the first technical baseline. Keep stable IDs `com_decaroinventory` and `pkg_decaroinventory`. Normal updates must preserve data and configuration.
